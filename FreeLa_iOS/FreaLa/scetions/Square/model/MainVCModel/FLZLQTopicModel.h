...
@class FLZlqItem;
@interface FLZLQTopicModel : NSObject

@property (nonatomic, assign) BOOL success;

@property (nonatomic, strong) NSArray<FLZlqItem *> *data;
...
@property (nonatomic, copy) NSString *snewDate;
