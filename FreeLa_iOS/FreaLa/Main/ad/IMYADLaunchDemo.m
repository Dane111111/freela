...
@property (nonatomic, strong) NSString* xjJumpURL;
@property (nonatomic, strong) NSString* xjImageURL;
@end
...
//        if ([XJFinalTool xjStringSafe:_xjImageURL]) {
//            [self show];
//        }
    });
     [self show];
...
//    imageView.image = [UIImage imageNamed:@"adimage.png"];
    NSString* xxxx = [[NSUserDefaults standardUserDefaults] objectForKey:@"xjADImageURL"];
    if ([XJFinalTool xjStringSafe:xxxx]) {
        [imageView sd_setImageWithURL:[NSURL URLWithString:_xjImageURL] placeholderImage:[UIImage imageNamed:@"LaunchImage"]];
    }
    _xjImageURL = @"http://123.57.35.196:9090/CJH/freela/resources/static/advert/1476350627081.png";
