...
#define K_SCREEN_H   FLUISCREENBOUNDS.width
...
-(void) initialView {
    self.frame = CGRectMake(0, 0, (CGFloat)FLUISCREENBOUNDS.width, (CGFloat)FLUISCREENBOUNDS.height);
    ...
    CGFloat w = (CGFloat)FLUISCREENBOUNDS.width - p*2;
