...
//        alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"自动登录失败" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
        FL_Log(@"this is the delegate to remind  自动登录failed");
        //发送自动登陆状态通知
        [[NSNotificationCenter defaultCenter] postNotificationName:KNOTIFICATION_LOGINCHANGE object:@NO];
    }
    else{
//        alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"开始自动登录" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
        FL_Log(@"this is the delegate to remind 开始自动登录");
...
-(void)didAutoLoginWithInfo:(NSDictionary *)loginInfo error:(EMError *)error
{
    ...
    if (error) {
//        alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"自动登录失败" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
        FL_Log(@"this is the delegate to remind aaa  自动登录failed too");
        //发送自动登陆状态通知
        //        [[NSNotificationCenter defaultCenter] postNotificationName:KNOTIFICATION_LOGINCHANGE object:@NO];
    }
    else{
...
//        alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"结束自动登录" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
        FL_Log(@"this is the delegate to remind  自动登录end");
    }
