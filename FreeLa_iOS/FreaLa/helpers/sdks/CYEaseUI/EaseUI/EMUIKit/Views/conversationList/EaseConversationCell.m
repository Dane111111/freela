...
CGFloat const EaseConversationCellPadding = 5;
...
- (void)_setupSubview
{
    ...
    //    _avatarView.layer.cornerRadius = 25;// 设置圆角
    ...
    [self _setupSeparateLineViewConstraints];
}
...
- (void)setModel:(id<IConversationModel>)model
{
    ...
    if (self.showAvatar) {
        if ([_model.avatarURLPath length] > 0){
            ...
            [self.avatarView.imageView sd_setImageWithURL:[NSURL URLWithString:avatarPath]placeholderImage:[UIImage imageNamed:@"defaultavater"]]; //
        } else {
            if (_model.avatarImage) {
                self.avatarView.image = [UIImage imageNamed:@"group"];
            }
        }
    }
